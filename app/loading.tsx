    ...
    return (
      <div className="flex flex-col items-center justify-center h-screen bg-success bg-opacity-10">
        <div className="relative">
          ...
          <div className="w-24 h-24 rounded-full animate-spin border-y-4 border-solid border-success border-b-transparent shadow-md absolute top-0 left-0 animate-[spin_3s_linear_infinite]"></div>
          <div className="w-24 h-24 rounded-full animate-spin border-y-4 border-solid border-success border-t-transparent shadow-md absolute top-0 left-0 animate-[spin_1.5s_linear_infinite]"></div>
        </div>
